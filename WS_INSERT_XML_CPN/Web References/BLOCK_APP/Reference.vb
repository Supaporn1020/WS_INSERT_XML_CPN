...
Namespace BLOCK_APP
    ...
    Partial Public Class WS_BLOCKCHAIN
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.WS_INSERT_XML_CPN.My.MySettings.Default.WS_INSERT_XML_CPN_BLOCK_APP_WS_BLOCKCHAIN
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/WS_BLOCK_CHAIN", RequestNamespace:="http://tempuri.org/", OneWay:=true, Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Sub WS_BLOCK_CHAIN(ByVal XML_BLOCKs As XML_BLOCK)
            Me.Invoke("WS_BLOCK_CHAIN", New Object() {XML_BLOCKs})
        End Sub
        ...
        Private Sub OnWS_BLOCK_CHAINOperationCompleted(ByVal arg As Object)
            If (Not (Me.WS_BLOCK_CHAINCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent WS_BLOCK_CHAINCompleted(Me, New System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.3761.0")>  _
    Public Delegate Sub WS_BLOCK_CHAINCompletedEventHandler(ByVal sender As Object, ByVal e As System.ComponentModel.AsyncCompletedEventArgs)
End Namespace
